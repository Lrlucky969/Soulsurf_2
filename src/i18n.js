...
const T = {
  ...
  "profile.bookings": { de: "Meine Buchungen", en: "My Bookings", pt: "Minhas Reservas" },
  "profile.noBookings": { de: "Noch keine Buchungen", en: "No bookings yet", pt: "Nenhuma reserva ainda" },
  "profile.findSchool": { de: "Surfschule finden", en: "Find surf school", pt: "Encontrar escola de surf" },
  "profile.cloudSync": { de: "Cloud-Sync", en: "Cloud Sync", pt: "Sincronização" },
  "profile.syncing": { de: "Synchronisiere...", en: "Syncing...", pt: "Sincronizando..." },
  "profile.synced": { de: "Synchronisiert ✓", en: "Synced ✓", pt: "Sincronizado ✓" },
  "profile.syncError": { de: "Sync-Fehler", en: "Sync error", pt: "Erro de sincronização" },
  "profile.syncIdle": { de: "Bereit", en: "Ready", pt: "Pronto" },
