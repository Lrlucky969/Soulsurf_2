...
export const SURF_SPOTS = [
  ...
  { id: "morocco", name: "Taghazout, Marokko", emoji: "🐪", image: "https://images.unsplash.com/photo-1530870110042-98b2cb110834?w=600&q=75", difficulty: "intermediate", waveType: "Rechte Pointbreaks", breakType: "point", hazards: ["locals", "reef"], season: "Okt–Mär", water: "18°C", wetsuit: "3/2mm", lat: 30.54, lng: -9.71, tips: ["Anchor Point ist ein legendärer Rechts-Pointbreak", "3/2mm Neopren empfohlen im Winter", "Günstige Surf-Camps mit Marokkanischem Essen"] },
  ...
  { id: "siargao", name: "Siargao, Philippinen", emoji: "🏄", image: "https://images.unsplash.com/photo-1464925257126-6450e871c667?w=600&q=75", difficulty: "intermediate", waveType: "Cloud 9 Riffwellen", breakType: "reef", hazards: ["reef", "current"], season: "Aug–Nov", water: "28°C", wetsuit: "none", lat: 9.85, lng: 126.16, tips: ["Cloud 9 ist weltberühmt – kräftige, hohle Rechtswelle", "Für Anfänger: Jacking Horse oder Stimpy's", "Tropenparadies – Palmen, türkises Wasser, entspannte Vibes"] },
];
...
export const CONTENT_POOL = {
  ...
  theory: [
    ...
    { title: "Dein Board kennen", icon: "🔍", duration: "8 Min", level: "beginner", phase: "early", content: "Nose, Tail, Rails, Finnen – jedes Teil hat eine Funktion.", tips: ["Nose: spitz = schnell, rund = stabil", "Tail: beeinflusst Wendigkeit (Round, Squash, Pin)", "Rails: dick = stabiler, dünn = schneller", "Finnen: 3er Setup (Thruster) am häufigsten"], keyTerms: ["Nose", "Tail", "Rails", "Stringer", "Thruster", "Rocker"], articleUrl: "https://tutorials.barefootsurftravel.com/articles/surfboard-dimensions-length-width-thickness-foil/", articleTitle: "📄 Board Anatomy – Barefoot Surf" },
    ...
    { title: "Surfboard Volume & Sizing", icon: "📏", duration: "10 Min", level: "intermediate", phase: "mid", content: "Volume in Litern bestimmt wie viel das Board dich trägt.", tips: ["Anfänger: 100% Körpergewicht in Litern", "Intermediate: 60-80%", "Advanced: 35-50%", "Volume-Rechner von Channel Islands nutzen"], articleUrl: "https://tutorials.barefootsurftravel.com/articles/surfboard-dimensions-length-width-thickness-foil/", articleTitle: "📄 Surfboard Volume – Barefoot Surf" },
