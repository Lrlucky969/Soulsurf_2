...
export default function BuilderScreen({ data, t, dm, navigate }) {
  ...
  return (
    <div style={{ paddingTop: 30 }}>
      ...
      {step === 2 && (
        <div style={{ animation: "slideUp 0.4s ease forwards", opacity: 0 }}>
          <div style={{ marginBottom: 28 }}>
            <label style={{ fontFamily: "'Space Mono', monospace", fontSize: 12, fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.1em", color: t.text2, display: "block", marginBottom: 10 }}>📅 Wie viele Tage? <span style={{ fontSize: 28, fontWeight: 900, color: "#009688", fontFamily: "'Playfair Display', serif" }}>{data.days}</span></label>
          ...
          <div style={{ display: "flex", gap: 10 }}>
            <button onClick={() => setStep(1)} style={{ background: t.inputBg, color: t.text2, border: `2px solid ${t.inputBorder}`, borderRadius: 14, padding: "16px 20px", fontSize: 14, cursor: "pointer" }}>← Zurück</button>
      ...
      {step === 3 && (
        <div style={{ animation: "slideUp 0.4s ease forwards", opacity: 0 }}>
          ...
          <div style={{ display: "flex", gap: 10 }}>
            <button onClick={() => setStep(2)} style={{ background: t.inputBg, color: t.text2, border: `2px solid ${t.inputBorder}`, borderRadius: 14, padding: "16px 20px", fontSize: 14, cursor: "pointer" }}>← Zurück</button>
      ...
      {step === 4 && (
        <div style={{ animation: "slideUp 0.4s ease forwards", opacity: 0 }}>
          <div style={{ marginBottom: 28 }}>
            <label style={{ fontFamily: "'Space Mono', monospace", fontSize: 12, fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.1em", color: t.text2, display: "block", marginBottom: 10 }}>🌍 Wo surfst du?</label>
