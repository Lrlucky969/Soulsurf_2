...
export default function EquipmentScreen({ data, t, dm }) {
    ...
    <div style={{ paddingTop: 24 }}>
      ...
      {data.coaching.boardHint && (
        <div style={{ background: dm ? "rgba(255,183,77,0.1)" : "#FFF8E1", borderRadius: 14, padding: "14px 16px", border: "1px dashed #FFB74D" }}>
          <div style={{ fontFamily: "'Space Mono', monospace", fontSize: 10, color: "#E65100", textTransform: "uppercase", marginBottom: 4 }}>🧠 Aus deinem Tagebuch</div>
